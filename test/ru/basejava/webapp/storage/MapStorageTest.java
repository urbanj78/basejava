...
public class MapStorageTest {
    ...
    void getAll() {
        ...
        actual.put("uuid1", new Resume(UUID_1));
        actual.put("uuid2", new Resume(UUID_2));
        actual.put("uuid3", new Resume(UUID_3));

        Assertions.assertArrayEquals(storage.getAll(), actual.values().toArray(new Resume[0]));
    }
