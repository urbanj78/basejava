...
public class ResumeTestData {
    public static Resume fillResume(String uuid, String fullName) {
        ...
        Company RITCenter = new Company(new Link("RIT Center", null), new ArrayList<>(List.of(new Company.Period(DateUtil.of(2012, Month.of(4)), DateUtil.of(2014, Month.of(10)), "Java архитектор", "Организация процесса разработки системы ERP для разных окружений: релизная политика, версионирование, ведение CI (Jenkins), миграция базы (кастомизация Flyway), конфигурирование системы (pgBoucer, Nginx), AAA via SSO. Архитектура БД и серверной части системы. Разработка интергационных сервисов: CMIS, BPMN2, 1C (WebServices), сервисов общего назначения (почта, экспорт в pdf, doc, html). Интеграция Alfresco JLAN для online редактирование из браузера документов MS Office. Maven + plugin development, Ant, Apache Commons, Spring security, Spring MVC, Tomcat,WSO2, xcmis, OpenCmis, Bonita, Python scripting, Unix shell remote scripting via ssh tunnels, PL/Python"))));
        ...
        resume.addSection(SectionType.EXPERIENCE, new CompanySection(new ArrayList<>(Arrays.asList(JOProjects, Wrike, RITCenter, LuxoftW, Yota, Enkata, SiemensW, AlcatelW))));

        Company Coursera = new Company(new Link("Coursera", "https://www.coursera.org/course/progfun"), new ArrayList<>(List.of(new Company.Period(DateUtil.of(2013, Month.of(3)), DateUtil.of(2013, Month.of(5)), "'Functional Programming Principles in Scala' by Martin Odersky", ""))));
        Company LuxoftE = new Company(new Link("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366"), new ArrayList<>(List.of(new Company.Period(DateUtil.of(2011, Month.of(3)), DateUtil.of(2011, Month.of(4)), "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.'", ""))));
        Company SiemensE = new Company(new Link("Siemens AG", "https://www.siemens.ru"), new ArrayList<>(List.of(new Company.Period(DateUtil.of(2005, Month.of(1)), DateUtil.of(2005, Month.of(4)), "3 месяца обучения мобильным IN сетям (Берлин)", ""))));
        Company AlcatelE = new Company(AlkatelLink, new ArrayList<>(List.of(new Company.Period(DateUtil.of(1997, Month.of(8)), DateUtil.of(1998, Month.of(3)), "6 месяцев обучения цифровым телефонным сетям (Москва)", ""))));
        Company IFMO = new Company(new Link("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "http://www.ifmo.ru/"), new ArrayList<>(Arrays.asList(new Company.Period(DateUtil.of(1993, Month.of(9)), DateUtil.of(1996, Month.of(7)), "Аспирантура (программист С, С++)", ""), new Company.Period(DateUtil.of(1987, Month.of(9)), DateUtil.of(1993, Month.of(7)), "Инженер (программист Fortran, C)", ""))));
        Company MIPT = new Company(new Link("Заочная физико-техническая школа при МФТИ", "https://mipt.ru/"), new ArrayList<>(List.of(new Company.Period(DateUtil.of(1984, Month.of(9)), DateUtil.of(1987, Month.of(6)), "Закончил с отличием", ""))));

        resume.addSection(SectionType.EDUCATION, new CompanySection(new ArrayList<>(Arrays.asList(Coursera, LuxoftE, SiemensE, AlcatelE, IFMO, MIPT))));
